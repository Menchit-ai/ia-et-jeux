...
from pacman.api import SearchProblem
from pacman import util
from ex01 import breadth_first_search


class CornersSearchProblem(SearchProblem):
    """
    ...
    *** YOUR CODE HERE ***
    ...
    def __init__(self, startingGameState):
        ...
        #
        "*** YOUR CODE HERE ***"
        self.food_corner = (False, False, False, False)
    ...
    def getStartState(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        return (self.startingPosition, self.food_corner)
